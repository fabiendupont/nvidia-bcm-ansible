...
description: ['Manages oci_instance_pools']
options:
    state:
      type: str
      choices:
    ...
    isClusterNetwork:
      description:
      - Is instance pool a part of cluster network
      type: bool
      required: false
      default: false
    instancePoolId:
      description:
      - Instance pool OCID (generated automatically by default)
      type: str
      required: false
    clusterNetworkId:
      description:
      - Cluster network OCID (if applicable, generated automatically by default)
      type: str
      required: false
...
oci_instance_pool:
  ...
  contains:
    ...
    clusterNetworkId:
      type: str
      description: Cluster network OCID (if applicable, generated automatically by
        default)
      returned: success
...
try:
    ...
    from pythoncm.entity import OCIInstancePool
except ImportError:
    HAS_PYTHONCM = False
...
from ansible_collections.brightcomputing.bcm110.plugins.module_utils.argspecs.oci_instance_pool import OCIInstancePool_ArgSpec
...
def main():
    ...
    module = BaseModule(
        argument_spec=OCIInstancePool_ArgSpec.argument_spec,
    ...
    entity = entity_manager.lookup_entity(params, OCIInstancePool)
    ...
    if not entity:
        if desired_state == "present":
            entity, res = entity_manager.create_resource(OCIInstancePool, params, commit=not module.check_mode)
            changed = True
    else:

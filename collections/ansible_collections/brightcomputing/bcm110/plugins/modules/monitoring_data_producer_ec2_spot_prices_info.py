...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_ec2_spot_prices_info
description: Query cmdaemon for entity of type MonitoringDataProducerEC2SpotPrices
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerEC2SpotPrices)
    ...
    module.exit_json(monitoring_data_producer_ec2_spot_pricess=json_ready_result, changed=False)

...
description: Query cmdaemon for entity of type NodeGroup
options:
...
def main():
    ...
    results = entity_query.find(NodeGroup)
    ...
    module.exit_json(node_groups=json_ready_result, changed=False)

...
DOCUMENTATION = r"""
---
module: ocigpu_memory_cluster_info
description: Query cmdaemon for entity of type OCIGPUMemoryCluster
options:
...
def main():
    ...
    results = entity_query.find(OCIGPUMemoryCluster)
    ...
    module.exit_json(ocigpu_memory_clusters=json_ready_result, changed=False)

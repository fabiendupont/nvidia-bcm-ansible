...
---
module: session_info
description: Query cmdaemon for entity of type Session
options:
...
try:
    ...
    from pythoncm.entity import Session
...
def main():
    ...
    results = entity_query.find(Session)
    ...
    module.exit_json(sessions=json_ready_result, changed=False)

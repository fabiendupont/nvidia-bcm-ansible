...
description: Query cmdaemon for entity of type CMService
options:
...
EXAMPLES = r"""
- name: register cm_service
  register: result
  brightcomputing.bcm110.cm_service_info: {}
- name: display all cm services
  debug:
    var: result.cm_services
...
try:
    ...
    from pythoncm.entity import CMService
...
def main():
    ...
    results = entity_query.find(CMService)
    ...
    module.exit_json(cm_services=json_ready_result, changed=False)

...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_network_utilization_info
description: Query cmdaemon for entity of type MonitoringDataProducerNetworkUtilization
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerNetworkUtilization)
    ...
    module.exit_json(monitoring_data_producer_network_utilizations=json_ready_result, changed=False)

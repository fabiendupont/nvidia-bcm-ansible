...
DOCUMENTATION = r"""
---
module: os_cloud_region_info
description: Query cmdaemon for entity of type OSCloudRegion
options:
...
def main():
    ...
    results = entity_query.find(OSCloudRegion)
    ...
    module.exit_json(os_cloud_regions=json_ready_result, changed=False)

...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_prs
description: ['Manages monitoring_data_producer_prss']
options:
    state:
      type: str
      choices:
...
try:
    ...
    from pythoncm.entity import MonitoringDataProducerPRS
except ImportError:
    HAS_PYTHONCM = False
...
from ansible_collections.brightcomputing.bcm110.plugins.module_utils.argspecs.monitoring_data_producer_prs import MonitoringDataProducerPRS_ArgSpec
...
def main():
    ...
    module = BaseModule(
        argument_spec=MonitoringDataProducerPRS_ArgSpec.argument_spec,
    ...
    entity = entity_manager.lookup_entity(params, MonitoringDataProducerPRS)
    ...
    if not entity:
        if desired_state == "present":
            entity, res = entity_manager.create_resource(MonitoringDataProducerPRS, params, commit=not module.check_mode)
            changed = True
    else:

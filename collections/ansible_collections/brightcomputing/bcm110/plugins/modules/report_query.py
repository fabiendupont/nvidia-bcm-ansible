...
---
module: report_query
description: ['Manages report_queries']
options:
    state:
      type: str
      choices:
...
from ansible_collections.brightcomputing.bcm110.plugins.module_utils.argspecs.report_query import ReportQuery_ArgSpec
...
def main():
    ...
    module = BaseModule(
        argument_spec=ReportQuery_ArgSpec.argument_spec,
    ...
    entity = entity_manager.lookup_entity(params, ReportQuery)
    ...
    if not entity:
        if desired_state == "present":
            entity, res = entity_manager.create_resource(ReportQuery, params, commit=not module.check_mode)
            changed = True
    else:

...
description: Query cmdaemon for entity of type OCIRegion
options:
...
def main():
    ...
    results = entity_query.find(OCIRegion)
    ...
    module.exit_json(oci_regions=json_ready_result, changed=False)

...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_aggregate_power_circuit_info
description: Query cmdaemon for entity of type MonitoringDataProducerAggregatePowerCircuit
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerAggregatePowerCircuit)
    ...
    module.exit_json(monitoring_data_producer_aggregate_power_circuits=json_ready_result, changed=False)

...
DOCUMENTATION = r"""
---
module: azure_location_info
description: Query cmdaemon for entity of type AzureLocation
options:
...
def main():
    ...
    results = entity_query.find(AzureLocation)
    ...
    module.exit_json(azure_locations=json_ready_result, changed=False)

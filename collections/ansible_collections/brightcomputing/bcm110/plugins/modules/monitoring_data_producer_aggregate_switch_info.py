...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_aggregate_switch_info
description: Query cmdaemon for entity of type MonitoringDataProducerAggregateSwitch
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerAggregateSwitch)
    ...
    module.exit_json(monitoring_data_producer_aggregate_switchs=json_ready_result, changed=False)

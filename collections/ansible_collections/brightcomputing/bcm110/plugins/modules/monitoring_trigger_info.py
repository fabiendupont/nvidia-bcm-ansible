...
DOCUMENTATION = r"""
---
module: monitoring_trigger_info
description: Query cmdaemon for entity of type MonitoringTrigger
options:
...
def main():
    ...
    results = entity_query.find(MonitoringTrigger)
    ...
    module.exit_json(monitoring_triggers=json_ready_result, changed=False)

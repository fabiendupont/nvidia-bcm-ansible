...
DOCUMENTATION = r"""
---
module: cooling_distribution_unit
description: ['Manages cooling_distribution_units']
options:
    state:
      type: str
      choices:
    ...
    racks:
      description:
      - List of racks cooled by this unit
      type: list
      required: false
      default: []
...
try:
    ...
    from pythoncm.entity import CoolingDistributionUnit
except ImportError:
    HAS_PYTHONCM = False
...
from ansible_collections.brightcomputing.bcm110.plugins.module_utils.argspecs.cooling_distribution_unit import CoolingDistributionUnit_ArgSpec
...
def main():
    ...
    module = BaseModule(
        argument_spec=CoolingDistributionUnit_ArgSpec.argument_spec,
    ...
    entity = entity_manager.lookup_entity(params, CoolingDistributionUnit)
    ...
    if not entity:
        if desired_state == "present":
            entity, res = entity_manager.create_resource(CoolingDistributionUnit, params, commit=not module.check_mode)
            changed = True
    else:

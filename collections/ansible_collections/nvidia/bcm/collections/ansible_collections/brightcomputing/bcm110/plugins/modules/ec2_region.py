...
---
module: ec2_region
description: ['Manages ec2_regions']
options:
    state:
      type: str
      choices:
...
try:
    ...
    from pythoncm.entity import EC2Region
except ImportError:
    HAS_PYTHONCM = False
...
from ansible_collections.brightcomputing.bcm110.plugins.module_utils.argspecs.ec2_region import EC2Region_ArgSpec
...
def main():
    ...
    module = BaseModule(
        argument_spec=EC2Region_ArgSpec.argument_spec,
    ...
    entity = entity_manager.lookup_entity(params, EC2Region)
    ...
    if not entity:
        if desired_state == "present":
            entity, res = entity_manager.create_resource(EC2Region, params, commit=not module.check_mode)
            changed = True
    else:

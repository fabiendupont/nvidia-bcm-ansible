...
DOCUMENTATION = r"""
---
module: cooling_distribution_unit_info
description: Query cmdaemon for entity of type CoolingDistributionUnit
options:
...
def main():
    ...
    results = entity_query.find(CoolingDistributionUnit)
    ...
    module.exit_json(cooling_distribution_units=json_ready_result, changed=False)

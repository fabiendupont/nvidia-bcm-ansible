...
from ansible_collections.brightcomputing.bcm110.plugins.module_utils.argspecs.head_node import HeadNode_ArgSpec
...
def main():
    ...
    module = BaseModule(
        argument_spec=HeadNode_ArgSpec.argument_spec,
    ...
    entity = entity_manager.lookup_entity(params, HeadNode)
    ...
    if not entity:
        if desired_state == "present":
            entity, res = entity_manager.create_resource(HeadNode, params, commit=not module.check_mode)
            changed = True
    else:

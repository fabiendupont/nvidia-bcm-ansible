...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_proc_vm_stat_info
description: Query cmdaemon for entity of type MonitoringDataProducerProcVMStat
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerProcVMStat)
    ...
    module.exit_json(monitoring_data_producer_proc_vm_stats=json_ready_result, changed=False)

...
DOCUMENTATION = r"""
---
module: drain_action_info
description: Query cmdaemon for entity of type DrainAction
options:
...
try:
    ...
    from pythoncm.entity import DrainAction
...
def main():
    ...
    results = entity_query.find(DrainAction)
    ...
    module.exit_json(drain_actions=json_ready_result, changed=False)

...
DOCUMENTATION = r"""
---
module: oci_provider_info
description: Query cmdaemon for entity of type OCIProvider
options:
...
def main():
    ...
    results = entity_query.find(OCIProvider)
    ...
    module.exit_json(oci_providers=json_ready_result, changed=False)

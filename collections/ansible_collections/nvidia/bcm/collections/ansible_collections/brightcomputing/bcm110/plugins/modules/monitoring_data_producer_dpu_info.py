...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_dpu_info
description: Query cmdaemon for entity of type MonitoringDataProducerDPU
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerDPU)
    ...
    module.exit_json(monitoring_data_producer_dpus=json_ready_result, changed=False)

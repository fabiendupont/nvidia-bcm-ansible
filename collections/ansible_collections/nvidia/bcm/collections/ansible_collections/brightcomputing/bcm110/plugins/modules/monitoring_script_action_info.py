...
DOCUMENTATION = r"""
---
module: monitoring_script_action_info
description: Query cmdaemon for entity of type MonitoringScriptAction
options:
...
def main():
    ...
    results = entity_query.find(MonitoringScriptAction)
    ...
    module.exit_json(monitoring_script_actions=json_ready_result, changed=False)

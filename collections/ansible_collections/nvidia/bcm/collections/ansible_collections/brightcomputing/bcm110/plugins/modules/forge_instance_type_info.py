...
DOCUMENTATION = r"""
---
module: forge_instance_type_info
description: Query cmdaemon for entity of type ForgeInstanceType
options:
...
def main():
    ...
    results = entity_query.find(ForgeInstanceType)
    ...
    module.exit_json(forge_instance_types=json_ready_result, changed=False)

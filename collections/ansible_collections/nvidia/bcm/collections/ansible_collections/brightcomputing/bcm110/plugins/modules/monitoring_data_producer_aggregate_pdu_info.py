...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_aggregate_pdu_info
description: Query cmdaemon for entity of type MonitoringDataProducerAggregatePDU
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerAggregatePDU)
    ...
    module.exit_json(monitoring_data_producer_aggregate_pdus=json_ready_result, changed=False)

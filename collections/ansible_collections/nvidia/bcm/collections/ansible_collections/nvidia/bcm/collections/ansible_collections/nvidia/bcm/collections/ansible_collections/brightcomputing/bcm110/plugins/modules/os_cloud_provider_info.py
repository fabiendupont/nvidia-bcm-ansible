...
DOCUMENTATION = r"""
---
module: os_cloud_provider_info
description: Query cmdaemon for entity of type OSCloudProvider
options:
...
def main():
    ...
    results = entity_query.find(OSCloudProvider)
    ...
    module.exit_json(os_cloud_providers=json_ready_result, changed=False)

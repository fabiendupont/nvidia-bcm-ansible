...
DOCUMENTATION = r"""
---
module: monitoring_consolidator_info
description: Query cmdaemon for entity of type MonitoringConsolidator
options:
...
def main():
    ...
    results = entity_query.find(MonitoringConsolidator)
    ...
    module.exit_json(monitoring_consolidators=json_ready_result, changed=False)

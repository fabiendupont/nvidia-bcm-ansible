...
DOCUMENTATION = r"""
---
module: monitoring_email_action_info
description: Query cmdaemon for entity of type MonitoringEmailAction
options:
...
def main():
    ...
    results = entity_query.find(MonitoringEmailAction)
    ...
    module.exit_json(monitoring_email_actions=json_ready_result, changed=False)

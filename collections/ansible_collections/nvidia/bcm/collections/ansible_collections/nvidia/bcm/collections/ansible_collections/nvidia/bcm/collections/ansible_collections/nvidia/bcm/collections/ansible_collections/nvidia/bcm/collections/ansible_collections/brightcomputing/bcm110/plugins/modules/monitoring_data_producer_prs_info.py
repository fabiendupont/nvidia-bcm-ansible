...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_prs_info
description: Query cmdaemon for entity of type MonitoringDataProducerPRS
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerPRS)
    ...
    module.exit_json(monitoring_data_producer_prss=json_ready_result, changed=False)

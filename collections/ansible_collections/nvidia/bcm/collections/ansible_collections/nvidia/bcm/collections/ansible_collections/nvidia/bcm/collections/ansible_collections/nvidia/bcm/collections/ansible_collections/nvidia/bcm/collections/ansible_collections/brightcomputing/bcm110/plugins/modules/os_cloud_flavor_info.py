...
DOCUMENTATION = r"""
---
module: os_cloud_flavor_info
description: Query cmdaemon for entity of type OSCloudFlavor
options:
...
try:
    ...
    from pythoncm.entity import OSCloudFlavor
...
def main():
    ...
    results = entity_query.find(OSCloudFlavor)
    ...
    module.exit_json(os_cloud_flavors=json_ready_result, changed=False)

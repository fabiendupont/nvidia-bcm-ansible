    ...
    def __init__(self):
        ...
        self.meta.add(
            MetaDataField(
                name="username",
                kind=MetaData.Type.STRING,
                description="Username to use for NetQ API calls",
                default='',
            )
        )
        self.meta.add(
            MetaDataField(
                name="password",
                kind=MetaData.Type.STRING,
                description="Password to use for NetQ API calls",
                default='',
            )
        )
        self.meta.add(
        ...
        self.baseType = 'NetQSettings'
        self.service_type = self.baseType
        self.allTypes = ['NetQSettings']

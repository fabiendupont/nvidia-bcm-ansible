...
from ansible_collections.brightcomputing.bcm110.plugins.module_utils.argspecs.certificate import Certificate_ArgSpec
...
def main():
    ...
    module = BaseModule(
        argument_spec=Certificate_ArgSpec.argument_spec,
    ...
    entity = entity_manager.lookup_entity(params, Certificate)
    ...
    if not entity:
        if desired_state == "present":
            entity, res = entity_manager.create_resource(Certificate, params, commit=not module.check_mode)
            changed = True
    else:

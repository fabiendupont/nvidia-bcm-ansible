...
class MonitoringDataProducerDPUSettingsEventTriogen(MonitoringDataProducerDPUSettingsEvent):
    ...
    def __init__(self):
        ...
        self.childType = 'MonitoringDataProducerDPUSettingsEventTriogen'
        self.service_type = self.baseType
        self.allTypes = ['MonitoringDataProducerDPUSettingsEventTriogen', 'MonitoringDataProducerDPUSettingsEvent']

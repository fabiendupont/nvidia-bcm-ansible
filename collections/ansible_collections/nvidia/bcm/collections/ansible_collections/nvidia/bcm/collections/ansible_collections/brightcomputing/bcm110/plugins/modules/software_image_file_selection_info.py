...
DOCUMENTATION = r"""
---
module: software_image_file_selection_info
description: Query cmdaemon for entity of type SoftwareImageFileSelection
options:
...
def main():
    ...
    results = entity_query.find(SoftwareImageFileSelection)
    ...
    module.exit_json(software_image_file_selections=json_ready_result, changed=False)

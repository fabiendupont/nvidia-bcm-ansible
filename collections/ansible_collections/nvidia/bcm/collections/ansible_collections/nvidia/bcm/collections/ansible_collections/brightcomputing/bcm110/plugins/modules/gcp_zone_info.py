...
DOCUMENTATION = r"""
---
module: gcp_zone_info
description: Query cmdaemon for entity of type GCPZone
options:
...
def main():
    ...
    results = entity_query.find(GCPZone)
    ...
    module.exit_json(gcp_zones=json_ready_result, changed=False)

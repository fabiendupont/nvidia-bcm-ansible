...
description: Query cmdaemon for entity of type Certificate
options:
...
def main():
    ...
    results = entity_query.find(Certificate)
    ...
    module.exit_json(certificates=json_ready_result, changed=False)

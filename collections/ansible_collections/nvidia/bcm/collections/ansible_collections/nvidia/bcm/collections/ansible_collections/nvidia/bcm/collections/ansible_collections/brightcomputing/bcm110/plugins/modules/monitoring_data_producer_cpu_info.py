...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_cpu_info
description: Query cmdaemon for entity of type MonitoringDataProducerCPU
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerCPU)
    ...
    module.exit_json(monitoring_data_producer_cpus=json_ready_result, changed=False)

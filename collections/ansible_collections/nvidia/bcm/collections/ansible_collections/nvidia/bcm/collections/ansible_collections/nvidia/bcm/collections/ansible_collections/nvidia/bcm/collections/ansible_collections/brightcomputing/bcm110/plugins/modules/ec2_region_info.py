...
DOCUMENTATION = r"""
---
module: ec2_region_info
description: Query cmdaemon for entity of type EC2Region
options:
...
def main():
    ...
    results = entity_query.find(EC2Region)
    ...
    module.exit_json(ec2_regions=json_ready_result, changed=False)

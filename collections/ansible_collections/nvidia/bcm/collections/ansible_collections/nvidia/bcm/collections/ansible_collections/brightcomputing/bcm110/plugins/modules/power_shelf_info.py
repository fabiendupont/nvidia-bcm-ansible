...
DOCUMENTATION = r"""
---
module: power_shelf_info
description: Query cmdaemon for entity of type PowerShelf
options:
...
def main():
    ...
    results = entity_query.find(PowerShelf)
    ...
    module.exit_json(power_shelfs=json_ready_result, changed=False)

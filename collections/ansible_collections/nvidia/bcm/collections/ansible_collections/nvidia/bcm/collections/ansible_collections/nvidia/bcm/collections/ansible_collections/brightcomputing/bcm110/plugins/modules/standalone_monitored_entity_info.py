...
DOCUMENTATION = r"""
---
module: standalone_monitored_entity_info
description: Query cmdaemon for entity of type StandaloneMonitoredEntity
options:
...
def main():
    ...
    results = entity_query.find(StandaloneMonitoredEntity)
    ...
    module.exit_json(standalone_monitored_entities=json_ready_result, changed=False)

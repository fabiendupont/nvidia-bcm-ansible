...
---
module: cloud_node
description: ['Manages cloud_nodes']
options:
    state:
      type: str
      choices:
    ...
    gpuSettings_NvidiaGPUSettings:
      ...
      options:
        ...
        secondaryWorkloadPowerProfile:
          ...
          - LLM_TRAINING
          - UNDEFINED
    cloudSettings_OCISettings:
      description:
      - Submode containing all cloud node settings
      type: dict
      required: false
      options:
        provider:
        ...
        tags:
          description:
          - List of tags that will be assigned to cloud instance (for supported providers)
          type: list
          required: false
          default: []
        compartmentId:
          description:
          - Compartment ID in OCI
          type: str
          required: false
        availabilityDomain:
          description:
        ...
        imageId:
          description:
          - 'ID of the image used to create instance (''latest'': use latest AMI, '''':
            inherit AMI from cloud provider)'
          type: str
          required: false
        ocpus:
          description:
          - Oracle CPUs. If set to 0 then the default value from the shape will be used
          type: int
          required: false
          default: 0
        memory:
          description:
          - Size of the node's main memory. If set to 0 then the default value from the
            shape will be used
          type: int
          required: false
          default: 0
        disks:
          description:
          - Definitions of storage devices of the VM
          type: list
          required: false
          default: []
          elements: dict
          options:
            ...
            maxVPUsPerGB:
              ...
              - This will be the maximum VPUs/GB performance level that the volume will
                be auto-tuned temporarily based on performance monitoring. This parameter
                has an effect only if performance based autotune is enabled
              type: int
              required: false
              default: 0
            enablePerformanceBasedAutotune:
              description:
              - If a volume is being throttled at the current setting for a certain period
                of time, auto-tune will gradually increase the volume's performance limited
                up to Maximum VPUs/GB. After the volume has been idle at the current setting
                for a certain period of time, auto-tune will gradually decrease the volume's
                performance limited down to Default/Minimum VPUs/GB
              type: bool
              required: false
              default: false
            enableDetachedAutotune:
              description:
        ...
        instancePool:
          description:
          - Instance pool to place the VM in
          type: str
          required: false
        gpuMemoryCluster:
          description:
          - GPU memory cluster the VM is in
          type: str
          required: false
        useKernelAndInitrdFromTheSoftwareImage:
          description:
          - Make the cloud node's node-installer download the kernel and the initrd from
            the software image configured for this cloud node and then reboot the cloud
            node to use those, instead of using the kernel and initrd already present
            on the node-installer's cloud image.
          type: bool
          required: false
          default: true
        definedTags:
          description:
          - List of OCI defined tags that will be assigned to cloud instance. Defined
            tags are case-insensitive and require the format 'namespace.key.value'
          type: list
          required: false
          default: []
        capacityType:
        ...
        capacityReservationId:
          description:
          - Capacity Reservation ID in OCI
          type: str
          required: false
        platformConfig:
          description:
          ...
          options:
            ...
            isSymmetricMultiThreadingEnabled:
              ...
              - Whether symmetric multithreading is enabled on the instance. Symmetric
                ...
                Hyper-Threading. Intel and AMD processors have two hardware execution
                threads per core (OCPU). SMT permits multiple independent threads of execution,
                to better use the resources and increase the efficiency of the CPU. When
                multithreading is disabled, only one thread is permitted to run on each
                core, which can provide higher or more predictable performance for some
                workloads.
              type: str
              required: false
              default: DEFAULT
            ...
            percentageOfCoresEnabled:
              ...
              - The percentage of cores enabled. Value must be a multiple of 25%. If the
                ...
                with a whole number of cores. If the applications that you run on the
                instance use a core-based licensing model and need fewer cores than the
                full size of the shape, you can disable cores to reduce your licensing
                costs. The instance itself is billed for the full shape, regardless of
                whether all cores are enabled.
              type: int
              required: false
              default: 0
        extra_values:
    ...
    cloudSettings_OSCloudSettings:
      ...
      options:
        ...
        instanceId:
          description:
          - Unique ID of the instance in OpenStack (the UUID).
          type: str
          required: false
        secGroupId:
          description:
        ...
        region:
          description:
          - The region of the cloud the VM is located in.
          type: str
          required: false
        flavor:
          description:
          - Instance Flavor (the type of the VM).
          type: str
          required: false
        image:
          description:
          - The name of the cloud image used for creating the VM.
          type: str
          required: false
        availabilityZone:
          description:
          - Availability zone the VM is supposed to be created in. If left empty, the
            availability zone will be automatically assigned by the cloud.
          type: str
          required: false
        externalIP:
          description:
          - The external IP address as set by the cloudprovider
          type: str
          required: false
          default: 0.0.0.0
        useKernelAndInitrdFromTheSoftwareImage:
        ...
        disks_OSCloudVolumeDisk:
          ...
          options:
            ...
            bootIndex:
              description:
              - Defines the order in which a hypervisor will try devices when attempting
                to boot the guest from storage. Setting a negative value indicates that
                the device should not be used for booting
              type: int
              required: false
              default: -1
            size:
            ...
            diskBus:
              description:
              - Hypervisor-specific details about disk bus type
              type: str
              required: false
            deviceType:
              description:
              - Hypervisor-specific details about disk device type
              type: str
              required: false
            removeOnTermination:
              description:
              - If true, the drive will be removed when the instance it is attached to
                gets terminated
              type: bool
              required: false
              default: true
            imageId:
              description:
              - Image ID to use as source for this disk
              type: str
              required: false
            snapshotId:
              description:
              - Snapshot ID to use as source for this disk
              type: str
              required: false
            volumeId:
              description:
              - Volume ID to use as source for this disk
              type: str
              required: false
        disks_OSCloudSwapDisk:
          description:
          - Definitions of storage devices of the VM.
          type: list
          required: false
    ...
    cloudSettings_GCPSettings:
      ...
      options:
        ...
        bootDiskType:
          description:
          - Disk type of the boot disk. The default is pd-standard.
          type: str
          required: false
        bootImageURI:
          description:
          - URI of boot image. Specify either a cloud storage directory, blob, or image
            resource.
          type: str
          required: false
        machineType:
        ...
        maintenancePolicy:
          description:
          - Host maintenance policy of the instance (MIGRATE, TERMINATE).
          type: str
          required: false
        provisioningModel:
          description:
          - Provisioning model of the instance (UNDEFINED_PROVISIONING_MODEL, STANDARD,
            SPOT, RESERVATION_BOUND).
          type: str
          required: false
        reservationName:
          description:
          - Reservation name to use if the reservation type is set to SPECIFIC_RESERVATION.
            This can be either a name to a reservation in the same project or 'projects/different-project/reservations/some-reservation-name'
            to target a shared reservation in the same zone but in a different project.
          type: str
          required: false
        reservationType:
          description:
          - Reservation type (ANY_RESERVATION, SPECIFIC_RESERVATION, NO_RESERVATION).
          type: str
          required: false
        resourcePolicies:
          description:
        ...
        disks:
          ...
          options:
            ...
            type:
              description:
              - Type of the disk. If not specified, the default is pd-standard.
              type: str
              required: false
            provisionedIOPS:
              description:
            ...
            provisionedThroughput:
              description:
              - Throughput (in MB/s) that the disk can handle.
              type: int
              required: false
              default: 0
            source:
              description:
              - 'Source image to use to create the disk. Specify the source in the following
                format: global/images/my-image.'
              type: str
              required: false
        extra_values:
          description: []
    ...
    cloudSettings_EC2Settings:
      ...
      options:
        ...
        instanceId:
          description:
          - Instance-ID provided by EC2
          type: str
          required: false
        spotId:
          description:
          - Spot-request-ID provided by EC2
          type: str
          required: false
        externalIP:
          description:
          ...
          required: false
          default: 0.0.0.0
        releaseStaticIPOnTermination:
          description:
          - Release Static IP on termination of the instance
          type: bool
          required: false
          default: true
        useKernelAndInitrdFromTheSoftwareImage:
        ...
        imageId:
          description:
          - 'ID of the AMI used to create instance (''latest'': use latest AMI, '''':
            inherit AMI from cloud provider)'
          type: str
          required: false
        usesMarketplaceImage:
          description:
          - Whether a paid AWS Marketplace is used for this node
          type: bool
          required: false
          default: false
        allocatePublicIP:
          description:
          - Whether to allocate a public IP for this instance. Always true for cloud directors.
          type: bool
          required: false
          default: false
        sourceDestinationCheck:
          description:
          - Whether to perform source/destination checks on the instance traffic.
          type: bool
          required: false
          default: true
        kernel:
          description:
          - Kernel used to create instance
          type: str
          required: false
        initrd:
          description:
          - Initial ramdisk used to create instance
          type: str
          required: false
        options:
          description:
          - User defined options passed to EC2 on instance creation
          type: str
          required: false
        cpuOptions:
          description:
          - 'CPU Options in AWS shorthand syntax (e.g: CoreCount=8,ThreadsPerCore=1)'
          type: str
          required: false
        spotPrice:
          description:
          - Maximum price to start instance with
          type: float
          required: false
          default: 0.0
        spotPersistent:
          description:
          - Persistent spot instances are requested again after they are automatically
            stopped, because price became to high
          type: bool
          required: false
          default: false
        useNonDefaultVirtualizationType:
          description: []
          type: bool
          required: false
          default: false
        placementGroup:
          description:
          - Start instance in the specified placement group
          type: str
          required: false
        iamInstanceProfile:
          description:
          - Name or ARN of instance profile to associate with
          type: str
          required: false
        capacityReservationPreference:
          description:
          - Capacity reservation preference ('open' or 'none')
          type: str
          required: false
        capacityReservationId:
          description:
        ...
        marketType:
          description:
          - Instance market type ('spot' or 'capacity-block')
          type: str
          required: false
        storage_EC2EphemeralStorage:
          description:
          - Assign EC2 storage
          type: list
          required: false
          ...
          options:
            ...
            tags:
              description:
              - List of tags that will be assigned to storage
              type: list
              required: false
              default: []
            volumeId:
        ...
        storage_EC2EBSStorage:
          ...
          options:
            ...
            persistent:
              description:
              - Persistent storage will not be removed when instance is removed
              type: bool
              required: false
              default: false
            volumeType:
              description:
              - Specifies what type of EBS volume to use
              type: str
              required: false
              default: GP2
              choices:
            ...
            iops:
              description:
              - Specifies the IOPS rate for the provisioned IOPS volume type
              type: int
              required: false
              default: 0
            encrypted:
            ...
            snapshotId:
              description:
              - ID of the snapshot which should be used to instantiate the new disk. This
                field can be used to speed up node provisioning by first provisioning
                a cloud compute node, creating a snapshot of its volumes, and then setting
                that snapshot ID in this field for remaining cloud compute nodes.
              type: str
              required: false
        extra_values:
          description: []
    ...
    cloudSettings_AzureSettings:
      ...
      options:
        ...
        storageAccountName:
          description:
          - Name of a storage account where boot diagnostics will be stored for this instance
          type: str
          required: false
        deploymentName:
          description:
          - Name of the Azure deployment associated with this node
          type: str
          required: false
        publicIpName:
          description:
          - Name of a public ip object to be assigned to the node
          type: str
          required: false
        VMSize:
          description:
        ...
        hyperVGeneration:
          description:
          - Hyper-V generation to use (V1 or V2), see https://docs.microsoft.com/en-us/azure/virtual-machines/generation-2
          type: str
          required: false
          default: UNDEFINED
          choices:
        ...
        availabilityZone:
          description:
          - Azure Availability zone where all the resources related to this VM will be
            allocated
          type: str
          required: false
        freeImageType:
        ...
        disks_AzureOSDisk:
          ...
          options:
            ...
            image:
              description:
              - URL to a source image for the disk
              type: str
              required: false
            storageAccountName:
              description:
              - Name of a storage account to hold the disk
              type: str
              required: false
            imageContainerName:
              description:
              - If the disk has the image url set, the image will be copied to a container
                with this name
              type: str
              required: false
              default: images
            containerName:
              description:
              - Name of a container in storage account to hold the disk
              type: str
              required: false
            managedDiskParameters:
              ...
              options:
                id:
                  description:
                  - Managed disks resource ID
                  type: str
                  required: false
                storageAccountType:
                  description:
                  - Storage account type for managed disks
                  type: str
                  required: false
        ...
        disks_AzureDataDisk:
          ...
          options:
            ...
            lun:
              description:
              - Logical unit number of a block device to be attached
              type: int
              required: false
              default: 0
            removeOnTermination:
              description:
              - If true, the drive will be removed when the instance it is atteched to
                gets terminated
              type: bool
              required: false
              default: true
...
try:
    ...
    from pythoncm.entity import CloudNode
except ImportError:
    HAS_PYTHONCM = False
...
from ansible_collections.brightcomputing.bcm110.plugins.module_utils.argspecs.cloud_node import CloudNode_ArgSpec
...
def main():
    ...
    module = BaseModule(
        argument_spec=CloudNode_ArgSpec.argument_spec,
    ...
    entity = entity_manager.lookup_entity(params, CloudNode)
    ...
    if not entity:
        if desired_state == "present":
            entity, res = entity_manager.create_resource(CloudNode, params, commit=not module.check_mode)
            changed = True
    else:

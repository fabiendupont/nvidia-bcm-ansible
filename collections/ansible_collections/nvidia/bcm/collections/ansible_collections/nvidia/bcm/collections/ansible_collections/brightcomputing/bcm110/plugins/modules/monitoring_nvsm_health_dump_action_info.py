...
DOCUMENTATION = r"""
---
module: monitoring_nvsm_health_dump_action_info
description: Query cmdaemon for entity of type MonitoringNVSMHealthDumpAction
options:
...
def main():
    ...
    results = entity_query.find(MonitoringNVSMHealthDumpAction)
    ...
    module.exit_json(monitoring_nvsm_health_dump_actions=json_ready_result, changed=False)

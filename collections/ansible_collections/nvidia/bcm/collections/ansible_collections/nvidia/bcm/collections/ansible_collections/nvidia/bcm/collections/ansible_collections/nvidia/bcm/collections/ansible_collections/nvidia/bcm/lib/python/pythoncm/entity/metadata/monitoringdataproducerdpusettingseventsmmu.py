...
class MonitoringDataProducerDPUSettingsEventSmmu(MonitoringDataProducerDPUSettingsEvent):
    ...
    def __init__(self):
        ...
        self.childType = 'MonitoringDataProducerDPUSettingsEventSmmu'
        self.service_type = self.baseType
        self.allTypes = ['MonitoringDataProducerDPUSettingsEventSmmu', 'MonitoringDataProducerDPUSettingsEvent']

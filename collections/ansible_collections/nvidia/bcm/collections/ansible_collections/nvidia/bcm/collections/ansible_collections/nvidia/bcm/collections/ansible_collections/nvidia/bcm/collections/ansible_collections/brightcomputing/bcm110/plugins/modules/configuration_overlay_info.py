...
DOCUMENTATION = r"""
---
module: configuration_overlay_info
description: Query cmdaemon for entity of type ConfigurationOverlay
options:
...
def main():
    ...
    results = entity_query.find(ConfigurationOverlay)
    ...
    module.exit_json(configuration_overlaies=json_ready_result, changed=False)

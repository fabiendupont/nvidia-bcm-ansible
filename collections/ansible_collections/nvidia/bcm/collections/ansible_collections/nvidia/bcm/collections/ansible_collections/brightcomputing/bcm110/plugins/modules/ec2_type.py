...
try:
    ...
    from pythoncm.entity import EC2Type
except ImportError:
    HAS_PYTHONCM = False
...
from ansible_collections.brightcomputing.bcm110.plugins.module_utils.argspecs.ec2_type import EC2Type_ArgSpec
...
def main():
    ...
    module = BaseModule(
        argument_spec=EC2Type_ArgSpec.argument_spec,
    ...
    entity = entity_manager.lookup_entity(params, EC2Type)
    ...
    if not entity:
        if desired_state == "present":
            entity, res = entity_manager.create_resource(EC2Type, params, commit=not module.check_mode)
            changed = True
    else:

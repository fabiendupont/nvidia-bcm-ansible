...
DOCUMENTATION = r"""
---
module: report_query_info
description: Query cmdaemon for entity of type ReportQuery
options:
...
try:
    ...
    from pythoncm.entity import ReportQuery
...
def main():
    ...
    results = entity_query.find(ReportQuery)
    ...
    module.exit_json(report_queries=json_ready_result, changed=False)

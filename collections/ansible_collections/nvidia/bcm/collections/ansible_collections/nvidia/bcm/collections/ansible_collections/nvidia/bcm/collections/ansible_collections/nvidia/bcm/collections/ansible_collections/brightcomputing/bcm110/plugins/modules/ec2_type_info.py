...
DOCUMENTATION = r"""
---
module: ec2_type_info
description: Query cmdaemon for entity of type EC2Type
options:
...
def main():
    ...
    results = entity_query.find(EC2Type)
    ...
    module.exit_json(ec2_types=json_ready_result, changed=False)

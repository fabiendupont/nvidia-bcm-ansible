...
DOCUMENTATION = r"""
---
module: forge_provider_info
description: Query cmdaemon for entity of type ForgeProvider
options:
...
def main():
    ...
    results = entity_query.find(ForgeProvider)
    ...
    module.exit_json(forge_providers=json_ready_result, changed=False)

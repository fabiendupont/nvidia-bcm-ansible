...
DOCUMENTATION = r"""
---
module: monitoring_measurable_health_check_info
description: Query cmdaemon for entity of type MonitoringMeasurableHealthCheck
options:
...
def main():
    ...
    results = entity_query.find(MonitoringMeasurableHealthCheck)
    ...
    module.exit_json(monitoring_measurable_health_checks=json_ready_result, changed=False)

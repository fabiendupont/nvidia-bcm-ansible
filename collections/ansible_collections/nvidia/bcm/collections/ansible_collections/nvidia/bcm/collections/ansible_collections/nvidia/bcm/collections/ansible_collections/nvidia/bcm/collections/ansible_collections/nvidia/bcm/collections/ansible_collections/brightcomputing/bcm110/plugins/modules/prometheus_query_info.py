...
DOCUMENTATION = r"""
---
module: prometheus_query_info
description: Query cmdaemon for entity of type PrometheusQuery
options:
...
def main():
    ...
    results = entity_query.find(PrometheusQuery)
    ...
    module.exit_json(prometheus_queries=json_ready_result, changed=False)

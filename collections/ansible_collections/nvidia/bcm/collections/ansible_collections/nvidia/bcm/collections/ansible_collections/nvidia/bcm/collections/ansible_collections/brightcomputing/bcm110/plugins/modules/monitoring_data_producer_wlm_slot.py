...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_wlm_slot
description: ['Manages monitoring_data_producer_wlm_slots']
options:
    state:
      type: str
      choices:
...
from ansible_collections.brightcomputing.bcm110.plugins.module_utils.argspecs.monitoring_data_producer_wlm_slot import MonitoringDataProducerWlmSlot_ArgSpec
...
def main():
    ...
    module = BaseModule(
        argument_spec=MonitoringDataProducerWlmSlot_ArgSpec.argument_spec,
    ...
    entity = entity_manager.lookup_entity(params, MonitoringDataProducerWlmSlot)
    ...
    if not entity:
        if desired_state == "present":
            entity, res = entity_manager.create_resource(MonitoringDataProducerWlmSlot, params, commit=not module.check_mode)
            changed = True
    else:

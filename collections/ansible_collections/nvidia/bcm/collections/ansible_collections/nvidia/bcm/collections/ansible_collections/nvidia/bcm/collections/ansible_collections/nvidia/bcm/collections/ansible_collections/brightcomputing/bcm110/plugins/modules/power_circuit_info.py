...
DOCUMENTATION = r"""
---
module: power_circuit_info
description: Query cmdaemon for entity of type PowerCircuit
options:
...
def main():
    ...
    results = entity_query.find(PowerCircuit)
    ...
    module.exit_json(power_circuits=json_ready_result, changed=False)

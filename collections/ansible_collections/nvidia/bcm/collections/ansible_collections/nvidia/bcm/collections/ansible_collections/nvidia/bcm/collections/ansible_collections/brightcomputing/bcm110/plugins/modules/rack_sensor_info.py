...
DOCUMENTATION = r"""
---
module: rack_sensor_info
description: Query cmdaemon for entity of type RackSensor
options:
...
def main():
    ...
    results = entity_query.find(RackSensor)
    ...
    module.exit_json(rack_sensors=json_ready_result, changed=False)

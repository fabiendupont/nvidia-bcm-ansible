...
DOCUMENTATION = r"""
---
module: azure_vm_size_info
description: Query cmdaemon for entity of type AzureVMSize
options:
...
def main():
    ...
    results = entity_query.find(AzureVMSize)
    ...
    module.exit_json(azure_vm_sizes=json_ready_result, changed=False)

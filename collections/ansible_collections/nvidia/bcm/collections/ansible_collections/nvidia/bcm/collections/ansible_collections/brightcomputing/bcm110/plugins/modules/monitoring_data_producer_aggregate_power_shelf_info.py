...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_aggregate_power_shelf_info
description: Query cmdaemon for entity of type MonitoringDataProducerAggregatePowerShelf
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerAggregatePowerShelf)
    ...
    module.exit_json(monitoring_data_producer_aggregate_power_shelfs=json_ready_result, changed=False)

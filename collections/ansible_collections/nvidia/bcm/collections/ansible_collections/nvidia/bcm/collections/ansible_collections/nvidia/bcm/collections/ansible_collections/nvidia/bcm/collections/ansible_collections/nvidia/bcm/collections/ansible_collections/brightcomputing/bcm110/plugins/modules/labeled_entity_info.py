...
DOCUMENTATION = r"""
---
module: labeled_entity_info
description: Query cmdaemon for entity of type LabeledEntity
options:
...
def main():
    ...
    results = entity_query.find(LabeledEntity)
    ...
    module.exit_json(labeled_entities=json_ready_result, changed=False)

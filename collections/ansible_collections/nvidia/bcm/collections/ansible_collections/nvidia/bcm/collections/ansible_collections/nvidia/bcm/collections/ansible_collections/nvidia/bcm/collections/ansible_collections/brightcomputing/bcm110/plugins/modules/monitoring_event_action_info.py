...
DOCUMENTATION = r"""
---
module: monitoring_event_action_info
description: Query cmdaemon for entity of type MonitoringEventAction
options:
...
def main():
    ...
    results = entity_query.find(MonitoringEventAction)
    ...
    module.exit_json(monitoring_event_actions=json_ready_result, changed=False)

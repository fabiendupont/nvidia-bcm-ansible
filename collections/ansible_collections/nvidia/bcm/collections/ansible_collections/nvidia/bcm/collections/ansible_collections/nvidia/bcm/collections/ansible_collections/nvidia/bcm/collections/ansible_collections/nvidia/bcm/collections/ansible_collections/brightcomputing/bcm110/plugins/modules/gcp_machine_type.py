...
DOCUMENTATION = r"""
---
module: gcp_machine_type
description: ['Manages gcp_machine_types']
options:
    state:
      type: str
      choices:
...
try:
    ...
    from pythoncm.entity import GCPMachineType
except ImportError:
    HAS_PYTHONCM = False
...
from ansible_collections.brightcomputing.bcm110.plugins.module_utils.argspecs.gcp_machine_type import GCPMachineType_ArgSpec
...
def main():
    ...
    module = BaseModule(
        argument_spec=GCPMachineType_ArgSpec.argument_spec,
    ...
    entity = entity_manager.lookup_entity(params, GCPMachineType)
    ...
    if not entity:
        if desired_state == "present":
            entity, res = entity_manager.create_resource(GCPMachineType, params, commit=not module.check_mode)
            changed = True
    else:

...
DOCUMENTATION = r"""
---
module: monitoring_consolidator
description: ['Manages monitoring_consolidators']
options:
    state:
      type: str
      choices:
    ...
    disabled:
      description:
      - Disable, consolidator for all entities. Do not throw away existing data.
      type: bool
      required: false
      default: false
    consolidators:
      ...
      options:
        ...
        maxAge:
          description:
          - Maximal age of historic data, 0 for forever
          type: float
          required: false
          default: 0.0
        maxSamples:
          description:
          - Maximal samples of historic data, 0 for no limit
          type: int
          required: false
          default: 65536
        interval:
        ...
        kind:
          description:
          - Kind of consolidation to be done
          type: str
          required: false
          default: AVERAGE
          choices:
...
monitoring_consolidator:
  ...
  contains:
    ...
    disabled:
      type: bool
      description: Disable, consolidator for all entities. Do not throw away existing
        data.
      returned: success
    consolidators:
      type: list
...
try:
    ...
    from pythoncm.entity import MonitoringConsolidator
except ImportError:
    HAS_PYTHONCM = False
...
from ansible_collections.brightcomputing.bcm110.plugins.module_utils.argspecs.monitoring_consolidator import MonitoringConsolidator_ArgSpec
...
def main():
    ...
    module = BaseModule(
        argument_spec=MonitoringConsolidator_ArgSpec.argument_spec,
    ...
    entity = entity_manager.lookup_entity(params, MonitoringConsolidator)
    ...
    if not entity:
        if desired_state == "present":
            entity, res = entity_manager.create_resource(MonitoringConsolidator, params, commit=not module.check_mode)
            changed = True
    else:

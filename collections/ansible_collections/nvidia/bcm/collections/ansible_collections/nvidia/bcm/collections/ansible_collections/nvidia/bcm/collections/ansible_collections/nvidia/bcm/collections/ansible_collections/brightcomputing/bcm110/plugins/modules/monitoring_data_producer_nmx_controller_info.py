...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_nmx_controller_info
description: Query cmdaemon for entity of type MonitoringDataProducerNMXController
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerNMXController)
    ...
    module.exit_json(monitoring_data_producer_nmx_controllers=json_ready_result, changed=False)

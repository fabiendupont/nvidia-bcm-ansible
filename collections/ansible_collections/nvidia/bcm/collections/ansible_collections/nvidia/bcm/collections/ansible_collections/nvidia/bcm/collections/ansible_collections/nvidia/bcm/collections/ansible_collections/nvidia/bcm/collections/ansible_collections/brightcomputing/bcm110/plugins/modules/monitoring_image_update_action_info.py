...
DOCUMENTATION = r"""
---
module: monitoring_image_update_action_info
description: Query cmdaemon for entity of type MonitoringImageUpdateAction
options:
...
def main():
    ...
    results = entity_query.find(MonitoringImageUpdateAction)
    ...
    module.exit_json(monitoring_image_update_actions=json_ready_result, changed=False)

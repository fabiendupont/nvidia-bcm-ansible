...
DOCUMENTATION = r"""
---
module: power_distribution_unit_info
description: Query cmdaemon for entity of type PowerDistributionUnit
options:
...
def main():
    ...
    results = entity_query.find(PowerDistributionUnit)
    ...
    module.exit_json(power_distribution_units=json_ready_result, changed=False)

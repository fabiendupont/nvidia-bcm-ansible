...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_single_line_health_check_script_info
description: Query cmdaemon for entity of type MonitoringDataProducerSingleLineHealthCheckScript
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerSingleLineHealthCheckScript)
    ...
    module.exit_json(monitoring_data_producer_single_line_health_check_scripts=json_ready_result, changed=False)

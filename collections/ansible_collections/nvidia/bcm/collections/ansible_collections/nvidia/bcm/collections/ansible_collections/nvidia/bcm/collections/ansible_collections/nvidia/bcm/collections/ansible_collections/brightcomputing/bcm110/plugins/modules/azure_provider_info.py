...
DOCUMENTATION = r"""
---
module: azure_provider_info
description: Query cmdaemon for entity of type AzureProvider
options:
...
def main():
    ...
    results = entity_query.find(AzureProvider)
    ...
    module.exit_json(azure_providers=json_ready_result, changed=False)

...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_red_fish_subscription_info
description: Query cmdaemon for entity of type MonitoringDataProducerRedFishSubscription
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerRedFishSubscription)
    ...
    module.exit_json(monitoring_data_producer_red_fish_subscriptions=json_ready_result, changed=False)

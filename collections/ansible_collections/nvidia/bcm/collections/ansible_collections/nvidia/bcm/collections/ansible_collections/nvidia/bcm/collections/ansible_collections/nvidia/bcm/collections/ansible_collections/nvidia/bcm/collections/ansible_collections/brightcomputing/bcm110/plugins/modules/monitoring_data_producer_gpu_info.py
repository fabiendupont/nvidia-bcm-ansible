...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_gpu_info
description: Query cmdaemon for entity of type MonitoringDataProducerGPU
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerGPU)
    ...
    module.exit_json(monitoring_data_producer_gpus=json_ready_result, changed=False)

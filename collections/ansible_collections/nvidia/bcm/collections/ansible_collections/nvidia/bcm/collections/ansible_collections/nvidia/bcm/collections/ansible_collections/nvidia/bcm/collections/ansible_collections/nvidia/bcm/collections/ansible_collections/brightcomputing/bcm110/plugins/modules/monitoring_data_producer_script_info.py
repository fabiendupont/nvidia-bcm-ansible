...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_script_info
description: Query cmdaemon for entity of type MonitoringDataProducerScript
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerScript)
    ...
    module.exit_json(monitoring_data_producer_scripts=json_ready_result, changed=False)

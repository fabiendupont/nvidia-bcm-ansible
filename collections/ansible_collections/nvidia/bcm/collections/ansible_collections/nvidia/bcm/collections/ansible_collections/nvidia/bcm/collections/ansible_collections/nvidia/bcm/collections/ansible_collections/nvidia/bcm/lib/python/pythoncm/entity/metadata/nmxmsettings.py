    ...
    def __init__(self):
        ...
        self.meta.add(
            MetaDataField(
                name="username",
                kind=MetaData.Type.STRING,
                description="Username to use for NMX-M API calls",
                default='',
            )
        )
        self.meta.add(
            MetaDataField(
                name="password",
                kind=MetaData.Type.STRING,
                description="Password to use for NMX-M API calls",
                default='',
            )
        )
        self.meta.add(
        ...
        self.baseType = 'NMXMSettings'
        self.service_type = self.baseType
        self.allTypes = ['NMXMSettings']

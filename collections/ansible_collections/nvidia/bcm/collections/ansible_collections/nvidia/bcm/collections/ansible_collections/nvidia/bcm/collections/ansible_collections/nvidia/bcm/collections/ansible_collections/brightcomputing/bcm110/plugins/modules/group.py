...
from ansible_collections.brightcomputing.bcm110.plugins.module_utils.argspecs.group import Group_ArgSpec
...
def main():
    ...
    module = BaseModule(
        argument_spec=Group_ArgSpec.argument_spec,
    ...
    entity = entity_manager.lookup_entity(params, Group)
    ...
    if not entity:
        if desired_state == "present":
            entity, res = entity_manager.create_resource(Group, params, commit=not module.check_mode)
            changed = True
    else:

...
DOCUMENTATION = r"""
---
module: monitoring_drain_action_info
description: Query cmdaemon for entity of type MonitoringDrainAction
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDrainAction)
    ...
    module.exit_json(monitoring_drain_actions=json_ready_result, changed=False)

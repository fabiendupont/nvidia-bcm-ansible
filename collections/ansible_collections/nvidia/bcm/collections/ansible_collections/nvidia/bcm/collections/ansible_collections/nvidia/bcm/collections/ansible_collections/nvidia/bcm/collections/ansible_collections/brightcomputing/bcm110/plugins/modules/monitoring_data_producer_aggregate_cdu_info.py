...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_aggregate_cdu_info
description: Query cmdaemon for entity of type MonitoringDataProducerAggregateCDU
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerAggregateCDU)
    ...
    module.exit_json(monitoring_data_producer_aggregate_cdus=json_ready_result, changed=False)

...
---
module: edge_site
description: ['Manages edge_sites']
options:
    state:
      type: str
      choices:
    ...
    nodes:
      description:
      - List of nodes in this site
      type: list
      required: false
      default: []
    switches:
      description:
      - List of switches in this site
      type: list
      required: false
      default: []
    genericDevices:
      description:
      - List of generic devices in this site
      type: list
      required: false
      default: []
    powerDistributionUnits:
      description:
      - List of power distribution units in this site
      type: list
      required: false
      default: []
    racks:
      description:
      - List of racks in this site
      type: list
      required: false
      default: []
    secret:
    ...
    metaDataDeviceLabel:
      description:
      - Meta data device label which to mount in order get the meta data
      type: str
      required: false
    metaDataUrl:
      description:
      - Meta data URL that contains information for edge directors
      type: str
      required: false
    createISO:
      description:
      - Edge site site ISO/script for USB
      type: str
      required: false
      default: SCRIPT
      choices:
    ...
    createIMG:
      description:
      - Edge site site IMG/script for MMC
      type: str
      required: false
      default: SCRIPT
      choices:
    ...
    includeCMSharedOnMedia:
      description:
      - Include /cm/shared on media to reduce the amount of rsync during edge director
        installation
      type: bool
      required: false
      default: false
    includeImagesOnMedia:
      description:
      - Include images on media to reduce the amount of rsync during edge director installation
      type: bool
      required: false
      default: false
    preStageRequestID:
      description:
      - Pre-staging request ID
    ...
    preStageRequestIDCreationTime:
      description:
      - Pre-staging request ID creation time
      type: int
      required: false
      default: 0
    extra_values:
...
from ansible_collections.brightcomputing.bcm110.plugins.module_utils.argspecs.edge_site import EdgeSite_ArgSpec
...
def main():
    ...
    module = BaseModule(
        argument_spec=EdgeSite_ArgSpec.argument_spec,
    ...
    entity = entity_manager.lookup_entity(params, EdgeSite)
    ...
    if not entity:
        if desired_state == "present":
            entity, res = entity_manager.create_resource(EdgeSite, params, commit=not module.check_mode)
            changed = True
    else:

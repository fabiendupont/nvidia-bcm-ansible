...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_single_line_metric_script_info
description: Query cmdaemon for entity of type MonitoringDataProducerSingleLineMetricScript
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerSingleLineMetricScript)
    ...
    module.exit_json(monitoring_data_producer_single_line_metric_scripts=json_ready_result, changed=False)

...
DOCUMENTATION = r"""
---
module: monitoring_measurable_enum_info
description: Query cmdaemon for entity of type MonitoringMeasurableEnum
options:
...
def main():
    ...
    results = entity_query.find(MonitoringMeasurableEnum)
    ...
    module.exit_json(monitoring_measurable_enums=json_ready_result, changed=False)

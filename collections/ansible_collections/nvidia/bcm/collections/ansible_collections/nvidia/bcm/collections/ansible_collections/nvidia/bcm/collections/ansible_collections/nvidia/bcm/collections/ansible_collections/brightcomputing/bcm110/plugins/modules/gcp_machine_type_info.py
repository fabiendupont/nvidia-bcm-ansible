...
DOCUMENTATION = r"""
---
module: gcp_machine_type_info
description: Query cmdaemon for entity of type GCPMachineType
options:
...
def main():
    ...
    results = entity_query.find(GCPMachineType)
    ...
    module.exit_json(gcp_machine_types=json_ready_result, changed=False)

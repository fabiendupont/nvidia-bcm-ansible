...
DOCUMENTATION = r"""
---
module: certificate_request_info
description: Query cmdaemon for entity of type CertificateRequest
options:
...
def main():
    ...
    results = entity_query.find(CertificateRequest)
    ...
    module.exit_json(certificate_requests=json_ready_result, changed=False)

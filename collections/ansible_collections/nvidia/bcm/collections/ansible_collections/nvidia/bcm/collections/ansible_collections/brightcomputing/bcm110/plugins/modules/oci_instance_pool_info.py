...
description: Query cmdaemon for entity of type OCIInstancePool
options:
...
def main():
    ...
    results = entity_query.find(OCIInstancePool)
    ...
    module.exit_json(oci_instance_pools=json_ready_result, changed=False)

...
DOCUMENTATION = r"""
---
module: bee_gfs_cluster_info
description: Query cmdaemon for entity of type BeeGFSCluster
options:
...
def main():
    ...
    results = entity_query.find(BeeGFSCluster)
    ...
    module.exit_json(bee_gfs_clusters=json_ready_result, changed=False)

...
DOCUMENTATION = r"""
---
module: cloud_node_info
description: Query cmdaemon for entity of type CloudNode
options:
...
def main():
    ...
    results = entity_query.find(CloudNode)
    ...
    module.exit_json(cloud_nodes=json_ready_result, changed=False)

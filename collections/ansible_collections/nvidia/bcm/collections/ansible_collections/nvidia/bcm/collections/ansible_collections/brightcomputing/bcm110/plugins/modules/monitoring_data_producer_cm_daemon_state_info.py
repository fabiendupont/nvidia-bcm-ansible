...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_cm_daemon_state_info
description: Query cmdaemon for entity of type MonitoringDataProducerCMDaemonState
options:
...
def main():
    ...
    results = entity_query.find(MonitoringDataProducerCMDaemonState)
    ...
    module.exit_json(monitoring_data_producer_cm_daemon_states=json_ready_result, changed=False)

...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_ec2_spot_prices
description: ['Manages monitoring_data_producer_ec2_spot_pricess']
options:
    state:
      type: str
      choices:
    ...
    customRegions:
      description:
      - Custom list of regions to collect data from
      type: list
      required: false
      default: []
    types:
      description:
      - Types to collect data for
      type: str
      required: false
      default: AUTOMATIC
      choices:
    ...
    customTypes:
      description:
      - Custom list of types to collect data from
      type: list
      required: false
      default: []
...
RETURN = r"""
---
monitoring_data_producer_ec2_spot_prices:
  type: complex
  description: ''
  returned: success
  contains:
...
try:
    ...
    from pythoncm.entity import MonitoringDataProducerEC2SpotPrices
except ImportError:
    HAS_PYTHONCM = False
...
from ansible_collections.brightcomputing.bcm110.plugins.module_utils.argspecs.monitoring_data_producer_ec2_spot_prices import MonitoringDataProducerEC2SpotPrices_ArgSpec
...
def main():
    ...
    module = BaseModule(
        argument_spec=MonitoringDataProducerEC2SpotPrices_ArgSpec.argument_spec,
    ...
    entity = entity_manager.lookup_entity(params, MonitoringDataProducerEC2SpotPrices)
    ...
    if not entity:
        if desired_state == "present":
            entity, res = entity_manager.create_resource(MonitoringDataProducerEC2SpotPrices, params, commit=not module.check_mode)
            changed = True
    else:

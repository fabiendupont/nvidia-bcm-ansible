...
DOCUMENTATION = r"""
---
module: monitoring_data_producer_cpu
description: ['Manages monitoring_data_producer_cpus']
options:
    state:
      type: str
      choices:
...
try:
    ...
    from pythoncm.entity import MonitoringDataProducerCPU
except ImportError:
    HAS_PYTHONCM = False
...
from ansible_collections.brightcomputing.bcm110.plugins.module_utils.argspecs.monitoring_data_producer_cpu import MonitoringDataProducerCPU_ArgSpec
...
def main():
    ...
    module = BaseModule(
        argument_spec=MonitoringDataProducerCPU_ArgSpec.argument_spec,
    ...
    entity = entity_manager.lookup_entity(params, MonitoringDataProducerCPU)
    ...
    if not entity:
        if desired_state == "present":
            entity, res = entity_manager.create_resource(MonitoringDataProducerCPU, params, commit=not module.check_mode)
            changed = True
    else:

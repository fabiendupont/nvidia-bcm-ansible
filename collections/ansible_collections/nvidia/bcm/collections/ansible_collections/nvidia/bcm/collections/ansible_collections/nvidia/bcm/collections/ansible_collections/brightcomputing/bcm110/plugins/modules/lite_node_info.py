...
DOCUMENTATION = r"""
---
module: lite_node_info
description: Query cmdaemon for entity of type LiteNode
options:
...
def main():
    ...
    results = entity_query.find(LiteNode)
    ...
    module.exit_json(lite_nodes=json_ready_result, changed=False)
